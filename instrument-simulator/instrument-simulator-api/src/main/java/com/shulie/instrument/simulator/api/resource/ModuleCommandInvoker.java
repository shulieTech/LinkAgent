...
public interface ModuleCommandInvoker {
     ...
     * @return
     */
    <T> CommandResponse<T> invokeCommand(String moduleId, String command, final Map<String, String> args);
     ...
     * @return
     */
    <T> CommandResponse<T> invokeCommand(String moduleId, String command);
}
