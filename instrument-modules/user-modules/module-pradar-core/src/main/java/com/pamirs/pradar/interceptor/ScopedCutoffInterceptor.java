...
public class ScopedCutoffInterceptor extends CutoffInterceptor implements ScopedInterceptor{
    ...
    public ScopedCutoffInterceptor(CutoffInterceptor interceptor, int policy) {
        this(interceptor, null, policy);
    }

    public ScopedCutoffInterceptor(CutoffInterceptor interceptor, InterceptorScope scope, int policy) {
        if (interceptor == null) {
