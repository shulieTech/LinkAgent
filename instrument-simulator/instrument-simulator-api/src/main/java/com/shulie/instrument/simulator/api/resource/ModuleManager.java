...
public interface ModuleManager {
     ...
     */
    void unload(String moduleId) throws ModuleException;
     ...
     */
    void active(String moduleId) throws ModuleException;
     ...
     */
    void frozen(String moduleId) throws ModuleException;
     ...
     * @return 模块
     */
    ExtensionModule get(String moduleId);
     ...
     */
    int getEffectClassCount(String moduleId) throws ModuleException;
     ...
     * @throws ModuleException 模块不存在
     */
    int getEffectMethodCount(String moduleId) throws ModuleException;
     ...
     * @throws ModuleException 模块不存在
     */
    boolean isActivated(String moduleId) throws ModuleException;
     ...
     * @throws ModuleException 模块不存在
     */
    boolean isLoaded(String moduleId) throws ModuleException;
     ...
     * @throws ModuleException 模块不存在
     */
    File getJarFile(String moduleId) throws ModuleException;
