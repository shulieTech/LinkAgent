 ...
 */
package com.pamirs.attach.plugin.mongodb.destroy;
 ...
 * @since 2021/06/16 5:10 下午
 */
public class MogoDestroyed implements Destroyed {
    @Override
    public void destroy() {
        MongoClientHolder.release();
        MongoClientPtCreate.release();
    }
}
