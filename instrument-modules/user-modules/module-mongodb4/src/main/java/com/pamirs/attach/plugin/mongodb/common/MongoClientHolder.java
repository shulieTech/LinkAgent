...
public class MongoClientHolder {
     ...
     * 高版本业务库和影子库的映射
     */
    public static Map<ReadConcern, OperationExecutor> mongoOperationExecutorMap = new HashMap<ReadConcern, OperationExecutor>(2, 2);
    ...
    public static Map<Object, Integer> mongoIntegerMap = new HashMap<Object, Integer>(2, 1);
    public static Map<Object, Map<String, String>> mongoTableMappingMap = new HashMap<Object, Map<String, String>>(2, 1);

    public static ThreadLocal<Object> mongoHolder = new ThreadLocal<Object>() {
        @Override
