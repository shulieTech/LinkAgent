 ...
 */
package com.pamirs.attach.plugin.neo4j.destroy;
...
import com.pamirs.attach.plugin.neo4j.operation.*;
 ...
 * @since 2021/6/16 1:52 下午
 */
public class Neo4jDestroy implements Destroyed {
    @Override
    public void destroy() {
        DataSourceWrapUtil.destroy();
        ListenerRegisterStatus.release();
        Neo4JSessionOperation.release();
    }
}
