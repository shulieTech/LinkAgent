...
/**
 * @ClassName: DoInTransactionOperation
 * @author: wangjian
 * @Date: 2020/8/1 00:19
 * @Description:
 */
public class DoInTransactionOperation extends AbstractOperation implements Operation {

    @Override
    public Object invoke(Neo4JSessionExt neo4jSession, Object[] args) {
        super.check(neo4jSession);
        return neo4jSession.doInTransaction((GraphCallback<Object>) args[0]);
    }
}
