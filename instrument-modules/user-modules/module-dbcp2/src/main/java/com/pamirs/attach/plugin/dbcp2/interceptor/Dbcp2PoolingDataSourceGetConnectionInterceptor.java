    ...
    public SpanRecord beforeTrace(Advice advice) {
        ...
        if (url == null) {
            ...
            if (ReflectionUtils.existsField(target, "_pool")) {
                pool = ReflectionUtils.getFieldValues(target, "_pool");
            } else {
                pool = ReflectionUtils.getFieldValues(target, "pool");
            }
            url = ReflectionUtils.getFieldValues(pool, "factory", "connectionFactory", "connectionString");
