...
cp ../target/simulator-agent-${AGENT_VERSION}-bin.zip ../target/simulator-agent-stable-bin.zip
cp ../target/simulator-agent-${AGENT_VERSION}-bin.tar ../target/simulator-agent-stable-bin.tar
