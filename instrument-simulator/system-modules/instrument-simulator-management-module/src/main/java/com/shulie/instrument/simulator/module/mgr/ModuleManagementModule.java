...
public class ModuleManagementModule implements ExtensionModule {
    ...
    public CommandResponse unload(final Map<String, String> param) {
        ...
        try {
            ...
            if (isNotBlank(moduleId)) {
                for (final ModuleSpec moduleSpec : searchByModuleId(moduleId)) {
                    try {
                        ...
                        logger.warn("SIMULATOR: unload module[id={};] occur error={}.", me.getModuleId(), me.getErrorCode(), me);
                    }
            ...
            logger.error("SIMULATOR: module management unload err. moduleId:{}", moduleId, e);
            return CommandResponse.failure(e);
        }
    }
    ...
    public CommandResponse active(final Map<String, String> param) throws ModuleException {
        ...
        try {
            ...
            if (isNotBlank(moduleId)) {
                for (final ModuleSpec moduleSpec : searchByModuleId(moduleId)) {
                    try {
                        ...
                        logger.warn("SIMULATOR: active module[id={};] occur error={}.", me.getModuleId(), me.getErrorCode(), me);
                    }
            ...
            logger.error("SIMULATOR: module management active err. moduleId:{}", moduleId, e);
            return CommandResponse.failure(e);
        }
    }
    ...
    public CommandResponse frozen(final Map<String, String> param) throws ModuleException {
        ...
        try {
            ...
            if (isNotBlank(moduleId)) {
                for (final ModuleSpec moduleSpec : searchByModuleId(moduleId)) {
                    try {
                        ...
                        logger.warn("SIMULATOR: frozen module[id={};] occur error={}.", me.getModuleId(), me.getErrorCode(), me);
                    }
            ...
            logger.error("SIMULATOR: module management frozen err. moduleId:{}", moduleId, e);
            return CommandResponse.failure(e);
        }
    }
