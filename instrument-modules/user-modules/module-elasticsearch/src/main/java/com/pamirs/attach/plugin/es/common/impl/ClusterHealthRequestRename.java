 ...
 * @Description
 * @Author ocean_wll
 * @Date 2021/11/3 5:04 下午
 */
public class ClusterHealthRequestRename extends AbstractReadRequestIndexRename {
    ...
    public List<String> reindex0(Object target) {
        ClusterHealthRequest req = (ClusterHealthRequest) target;
