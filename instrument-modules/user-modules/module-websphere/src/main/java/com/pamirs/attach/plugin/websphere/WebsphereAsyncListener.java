...
public class WebsphereAsyncListener implements AsyncListener {
    ...
    public WebsphereAsyncListener(final AsyncContext asyncContext, final Map<String, String> invokeContext_, final HttpServletRequest request, final HttpServletResponse response, final RequestTracer<HttpServletRequest, HttpServletResponse> requestTracer) {
