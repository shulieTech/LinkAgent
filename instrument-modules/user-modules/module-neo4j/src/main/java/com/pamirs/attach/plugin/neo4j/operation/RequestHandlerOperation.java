...
/**
 * @ClassName: RequestHandlerOperation
 * @author: wangjian
 * @Date: 2020/8/1 00:20
 * @Description:
 */
public class RequestHandlerOperation extends AbstractOperation implements Operation {

    @Override
    public Object invoke(Neo4JSessionExt neo4jSession, Object[] args) {
        check(neo4jSession);
        return neo4jSession.requestHandler();
    }
}
