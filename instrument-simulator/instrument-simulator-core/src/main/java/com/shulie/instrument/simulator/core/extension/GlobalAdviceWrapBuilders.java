...
public class GlobalAdviceWrapBuilders {
    ...
    public synchronized static void addAdviceListenerWrapBuilder(AdviceListenerWrapBuilder adviceListenerWrapBuilder) {
        ArrayList<AdviceListenerWrapBuilder> list = new ArrayList<AdviceListenerWrapBuilder>(adviceListenerWrapBuilders);
        list.add(adviceListenerWrapBuilder);
        adviceListenerWrapBuilders = list;
    }

    static List<AdviceListenerWrapBuilder> getAdviceListenerWrapBuilders() {
