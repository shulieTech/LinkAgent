...
public class JedisConnectionSendProtocolCommandTraceInterceptor extends TraceInterceptorAdaptor {
    ...
    public SpanRecord beforeTrace(Advice advice) {
        ...
        String method = ((String) args[1]).toLowerCase();
    ...
    public SpanRecord afterTrace(Advice advice) {
        ...
        String method = ((String) advice.getParameterArray()[1]).toLowerCase();
        if (!METHOD_KEYS.contains(method)) {
            return null;
        }
        SpanRecord record = new SpanRecord();
