 ...
 */
public class RollingFileShadowAppenderCreator implements ShadowAppenderCreator<RollingFileAppender> {

    private final static Logger logger = LoggerFactory.getLogger(RollingFileShadowAppenderCreator.class);

    @Override
    public RollingFileAppender creatorPtAppender(RollingFileAppender appender, String bizShadowLogPath) {
