...
public final class NettyConstants {
    ...
    public final static String PLUGIN_NAME = "netty";
    public final static int PLUGIN_TYPE = MiddlewareType.TYPE_RPC;

    public final static String MODULE_NAME = "netty";

    public final static String DYNAMIC_FIELD_ASYNC_CONTEXT = "asyncContext";
