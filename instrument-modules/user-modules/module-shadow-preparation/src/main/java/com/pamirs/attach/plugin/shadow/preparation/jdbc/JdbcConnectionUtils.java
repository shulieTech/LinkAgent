...
public class JdbcConnectionUtils {
     ...
     * @throws Exception
     */
    public static Map<String, List<JdbcTableColumnInfos>> fetchTablesStructures(Connection connection, List<String> tables, JdbcTypeEnum typeEnum) throws Exception {
        if (tables.isEmpty()) {
        ...
        for (String table : tables) {
            ...
            switch (typeEnum) {
                case MYSQL:
                case GBASE:
                    columnInfos = fetchColumnInfosByJDBC(connection, table);
                    break;
                case ORACLE:
     ...
     * @throws Exception
     */
    public static List<JdbcTableColumnInfos> fetchColumnInfosByJDBC(Connection connection, String table) throws Exception {
