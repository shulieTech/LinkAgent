 ...
 * @since 2020/11/13 5:20 下午
 */
public class HttpServletRequestImpl implements HttpServletRequest {
    private IRequest servletRequest;

    public HttpServletRequestImpl(IRequest servletRequest) {
    ...
    public String getRequestedSessionId() {
        return servletRequest.getSessionID();
    }
    ...
    public StringBuffer getRequestURL() {
        return new StringBuffer(servletRequest.getRequestURI());
    }
    ...
    public ServletInputStream getInputStream() throws IOException {
        return new ServletInputStreamImpl(servletRequest.getInputStream());
    }
    ...
    public BufferedReader getReader() throws IOException {
        return new BufferedReader(new InputStreamReader(servletRequest.getInputStream()));
    }
