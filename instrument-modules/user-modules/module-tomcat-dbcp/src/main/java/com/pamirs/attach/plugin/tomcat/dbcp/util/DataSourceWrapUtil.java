 ...
 */
package com.pamirs.attach.plugin.tomcat.dbcp.util;
        ...
        synchronized (lock) {
            ...
            if (!validate(target)) {
                ...
                ErrorReporter.buildError()
                        ...
                        .setDetail("dbcp2:DataSourceWrapUtil:业务库配置:::url: " + target.getUrl() + "; username：" + dataSourceMeta.getUsername() + "; 中间件类型：dbcp2")
