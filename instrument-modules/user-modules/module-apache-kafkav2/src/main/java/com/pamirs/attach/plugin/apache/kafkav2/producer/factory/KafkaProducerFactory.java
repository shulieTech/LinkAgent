 ...
 * @Date 2022/8/8 11:42
 */
public class KafkaProducerFactory implements ShadowResourceProxyFactory {

    @Override
    public ShadowResourceLifecycle createShadowResource(Object bizTarget) {
        if (bizTarget instanceof Producer) {
            return new KafkaJavaApiProducerResource((Producer) bizTarget);
        }
        return null;
    }
}
