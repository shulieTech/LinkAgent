...
public abstract class StringMatcher<T extends Key<?>> implements Matcher<T> {
    ...
    protected org.quartz.impl.matchers.StringMatcher.StringOperatorName compareWith;

    protected StringMatcher(String compareTo, org.quartz.impl.matchers.StringMatcher.StringOperatorName compareWith) {
        if (compareTo == null)
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        org.quartz.impl.matchers.StringMatcher<?> other = (org.quartz.impl.matchers.StringMatcher<?>) obj;
        if (compareTo == null) {
    ...
    public org.quartz.impl.matchers.StringMatcher.StringOperatorName getCompareWithOperator() {
        return compareWith;
    }
