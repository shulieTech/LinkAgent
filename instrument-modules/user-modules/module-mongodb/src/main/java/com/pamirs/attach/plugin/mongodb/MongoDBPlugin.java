...
public class MongoDBPlugin extends ModuleLifecycleAdapter implements ExtensionModule {
    ...
    public boolean onActive() throws Throwable {
        ...
        enhanceTemplate.enhance(this, "com.mongodb.async.client.OperationExecutorImpl", new EnhanceCallback() {
            @Override
            public void doEnhance(InstrumentClass target) {

                /**
                 * 读取操作
                 * com.mongodb.async.client.OperationExecutorImpl#execute(com.mongodb.operation.AsyncReadOperation<T>, com.mongodb.ReadPreference, com.mongodb.ReadConcern, com.mongodb.async.client.ClientSession, com.mongodb.async.SingleResultCallback<T>)
                 */
                InstrumentMethod readExecute = target.getDeclaredMethod("execute",
                        "com.mongodb.operation.AsyncReadOperation",
                        "com.mongodb.ReadPreference", "com.mongodb.ReadConcern", "com.mongodb.async.client.ClientSession", "com.mongodb.async.SingleResultCallback");


                if (readExecute != null) {
                    readExecute.addInterceptor(Listeners.of(AsyncOperationExecutorImplInterceptor.class));
                }

                /**
                 * 写操作
                 * com.mongodb.async.client.OperationExecutorImpl#execute(com.mongodb.operation.AsyncWriteOperation<T>, com.mongodb.ReadConcern, com.mongodb.async.client.ClientSession, com.mongodb.async.SingleResultCallback<T>)
                 */
                InstrumentMethod writeExecute = target.getDeclaredMethod("execute",
                        "com.mongodb.operation.AsyncWriteOperation", "com.mongodb.ReadConcern", "com.mongodb.async.client.ClientSession", "com.mongodb.async.SingleResultCallback");

                if (writeExecute != null) {
                    writeExecute.addInterceptor(Listeners.of(AsyncOperationExecutorImplInterceptor.class));
                }
            }
        });
