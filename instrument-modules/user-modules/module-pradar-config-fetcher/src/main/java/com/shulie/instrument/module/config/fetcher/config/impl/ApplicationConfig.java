...
public class ApplicationConfig extends AbstractConfig<ApplicationConfig> {
    ...
    public static Boolean getPlugin = Boolean.FALSE;
    /**
     * war name list
     */
     ...
     * 插件-redis最大过期时间
     */
    private Float pluginMaxRedisExpireTime;
    ...
    public ApplicationConfig(ConfigResolver<ApplicationConfig> resolver) {
        ...
        this.pluginMaxRedisExpireTime = -1f;
    }
    ...
    public Float getPluginMaxRedisExpireTime() {
        return pluginMaxRedisExpireTime;
    }

    public void setPluginMaxRedisExpireTime(Float pluginMaxRedisExpireTime) {
        this.pluginMaxRedisExpireTime = pluginMaxRedisExpireTime;
    }
}
