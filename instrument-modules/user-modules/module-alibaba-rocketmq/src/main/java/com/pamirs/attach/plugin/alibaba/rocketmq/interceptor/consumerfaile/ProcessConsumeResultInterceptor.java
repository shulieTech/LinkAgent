...
public class ProcessConsumeResultInterceptor extends AroundInterceptor {
    ...
    public void doBefore(Advice advice) {
        ...
        logger.error("执行ProcessConsumeResultInterceptor before, topic is " + topic + " queueId is " + queueId);
    ...
    public void doAfter(Advice advice) {
        logger.error("执行ProcessConsumeResultInterceptor after, topic is " + topic + " queueId is " + queueId);
    }
    ...
    public void doException(Advice advice) {
        ...
        logger.error("执行ProcessConsumeResultInterceptor before, topic is " + topic +
