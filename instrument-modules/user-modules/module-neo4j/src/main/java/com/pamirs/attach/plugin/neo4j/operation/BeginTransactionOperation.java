...
/**
 * @ClassName: BeginTransactionOperation
 * @author: wangjian
 * @Date: 2020/8/1 00:19
 * @Description:
 */
public class BeginTransactionOperation extends AbstractOperation {
    ...
    public Object invoke(Neo4JSessionExt neo4jSession, Object[] args) {
        ...
        return neo4jSession.beginTransaction((Transaction.Type) args[0]);
    }
}
