...
/**
 * @ClassName: DisposeOperation
 * @author: wangjian
 * @Date: 2020/8/1 00:17
 * @Description:
 */
public class DisposeOperation extends AbstractOperation implements Operation {
    @Override
    public Object invoke(Neo4JSessionExt neo4jSession, Object[] args) {
        check(neo4jSession);
        return neo4jSession.dispose((EventListener) args[0]);
    }
}
