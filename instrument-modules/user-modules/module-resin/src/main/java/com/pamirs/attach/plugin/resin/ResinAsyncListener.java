...
public class ResinAsyncListener implements AsyncListener {
    ...
    public ResinAsyncListener(final AsyncContext asyncContext, final Map<String, String> invokeContext_, final HttpServletRequest request, final HttpServletResponse response, final RequestTracer<HttpServletRequest, HttpServletResponse> requestTracer) {
