...
/**
 * @ClassName: ResolveGraphIdForOperation
 * @author: wangjian
 * @Date: 2020/8/1 00:19
 * @Description:
 */
public class ResolveGraphIdForOperation extends AbstractOperation implements Operation {

    @Override
    public Object invoke(Neo4JSessionExt neo4jSession, Object[] args) {
        check(neo4jSession);
        return neo4jSession.resolveGraphIdFor(args[0]);
    }
}
