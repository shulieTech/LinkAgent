...
/**
 * @ClassName: TransactionManagerOperation
 * @author: wangjian
 * @Date: 2020/8/1 00:21
 * @Description:
 */
public class TransactionManagerOperation extends AbstractOperation implements Operation {

    @Override
    public Object invoke(Neo4JSessionExt neo4jSession, Object[] args) {
        check(neo4jSession);
        return neo4jSession.transactionManager();
    }
}
