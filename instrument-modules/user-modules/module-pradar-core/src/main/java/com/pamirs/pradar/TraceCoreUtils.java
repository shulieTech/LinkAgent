...
public class TraceCoreUtils {
    ...
    public static String localAttributes(Object upAppName,
        ...
        return isMockResponse ? combineString(upAppName, remoteIp, remotePort, requestSize, responseSize, "M") : combineString(upAppName, remoteIp, remotePort, requestSize, responseSize);
    }
